<?php
/**
 * Teste específico para envio de arquivos via base64
 * Acesse: https://presenca.aom.org.br/teste_arquivo_base64.php
 */
...
$arquivo_teste = '/tmp/teste_arquivo.csv';
file_put_contents($arquivo_teste, $conteudo_teste);

// Converter para base64
$base64_arquivo = base64_encode($conteudo_teste);

echo "<h2>Teste de Envio de Arquivo via Base64</h2>";
echo "<p><strong>Número:</strong> $numero_teste</p>";
echo "<p><strong>Arquivo:</strong> teste_arquivo.csv</p>";
echo "<p><strong>Tamanho base64:</strong> " . strlen($base64_arquivo) . " bytes</p>";
echo "<hr>";

// Dados para envio via WhatsApp com base64
$dados = [
    'phone' => $numero_teste,
    'isGroup' => false,
    'isNewsletter' => false,
    'isLid' => false,
    'filename' => 'teste_arquivo.csv',
    'caption' => '📈 Teste de arquivo CSV - ' . date('d/m/Y H:i:s'),
    'base64' => $base64_arquivo
];
