<?php
/**
 * Teste do Monitor de Leitura Facial (Tempo Real)
 */

echo "<h1>🧪 Teste do Monitor de Leitura Facial (Tempo Real)</h1>";

// Testar a API de tempo real
echo "<h2>1. Teste da API de Tempo Real</h2>";
