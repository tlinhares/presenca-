<?php
// Versão simplificada para cadastrar usuários no dispositivo SS3542 usando cURL
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
    ...
    <title>Cadastro com cURL - SS3542</title>
...
<body>
    <div class="container">
        <h1 class="text-center mb-4">Cadastro com cURL - SS3542</h1>
        ...
        if (isset($_POST['submit'])) {
            ...
            $success = ($httpcode == 200 || empty($error)) ? true : false;
