...
<div class="header-page">
    <div class="container d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center gap-3"><a href="<?= MenuPermissaoService::ajustarUrl('/painel/dashboard.php') ?>" class="btn btn-outline-light btn-sm" title="Voltar ao Painel"><i class="bi bi-arrow-left"></i></a><h5 class="mb-0"><i class="bi bi-phone-vibrate-fill me-2"></i>Divulgar Aplicativo</h5></div>
    </div>
</div>
