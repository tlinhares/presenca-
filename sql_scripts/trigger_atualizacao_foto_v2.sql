-- Trigger para detectar atualização de foto de usuário (versão melhorada)
...
BEGIN
    ...
    -- Usar LENGTH para detectar mudanças no tamanho ou ISNULL para detectar mudanças de NULL
    IF (
