...
try {
    ...
    $sql_proprias = "SELECT u.nome, 1 as quantidade, 'Própria' as origem, ra.data, ra.valor as valor
    ...
    $sql_adicionais = "SELECT u.nome as usuario_nome, d.nome as dependente_nome, 1 as quantidade, 'Adicional' as origem, ra.data, ra.valor
                      FROM reservas_adicionais ra
                      JOIN dependentes d ON ra.id_usuario = d.id
